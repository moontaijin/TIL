...
위 코드에서 알 수 있듯, 클래스의 인스턴스를 함수처럼 호출하기 위해서는 클래스에 ```__call__```이라는 [매직 메소드](https://github.com/moontaijin/TIL/blob/master/Python/%ED%8C%8C%EC%9D%B4%EC%8D%AC%20%EC%9A%A9%EC%96%B4%20%EC%A0%95%EB%A6%AC.md)를 정의해야한다.
